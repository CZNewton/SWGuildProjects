...
<html>
    ...
    <body>
        ...
        <div class="col-xs-7 body">
            <h3>Editing Sighting #${editTargetSight.sightingID}</h3>
            <form class="form-group" action="newSight">
                <input type="text" name="Address" value="${editTargetSight.address}">
                <input type="number" step=".01" name="LatitudeDMS" value="${editTargetSight.latitudeDMS}">
                <select class="selectpicker" name="LatitudeDir">
                    <option>N</option>
                    <option>S</option>
                </select>
                <input type="number" step=".01" name="LongitudeDMS" value="${editTargetSight.longitudeDMS}">
                <select class="selectpicker" name="LongitudeDir">
                    <option>E</option>
                    <option>W</option>
                </select>
                <input type="date" name="sightDate" value="${editTargetSight.dateSeen}">
