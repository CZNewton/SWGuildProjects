            ...
            <div class="form-group" name="inputSuper" id="input">
                <form method="GET" action="newSuper">
                    ...
                    <div class="col-xs-6 form-group">
                        <input type="text" class="form-control" name="name" placeholder="Name of super">
                    </div>
                    <div class="col-xs-4 form-group">
                        <input name="height" type="number" step="1" class="form-control" placeholder="Height (in meters)">
                    </div>
                    <div class="col-xs-6">
                        <input name="weight" type="number" step="1" class="form-control" placeholder="Weight">
                    ...
                    <textarea class="form-control" rows="5" type="text" name="power" placeholder="Description of power(s)"></textarea>
                    <input name="PL" type="number" step="1" placeholder="powerlevel">
